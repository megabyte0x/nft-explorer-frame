...
function getCollectionLink(collection_name) {
    let link;
...
async function getData(collection_name, evm_address) {
    let nfts_response;
    let data;
    let totalCount = 0;
    const totalEVMAddresses = evm_address.length;
    const nfts = [];
    const collection_link = getCollectionLink(collection_name);
    let status = false;
